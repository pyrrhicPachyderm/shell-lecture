...
\begin{frame}{Accessing the Internet}
	...
	\begin{itemize}
		\item \texttt{wget http://www.example.com}
	\end{itemize}
	We can use \texttt{\hyphen O} to set the output file.
	\begin{itemize}
		\item \texttt{wget http://www.example.com \hyphen O example.html}
	\end{itemize}
\end{frame}
...
\begin{frame}{Regular Expression}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \text{grep "c.*t"}
		\end{itemize}
		\item \texttt{[]} match any character insdie them
		\begin{itemize}
			\item \text{grep "[Cc]at"}
		\end{itemize}
	\end{itemize}
